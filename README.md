...
- **Invoice-ready workflows** with sequential Smart Summit invoice numbers, formal PDF exports, and branded previews for every income or expense entry.
- **Split income payments** so each deal can capture up to four installments that roll into the totals, tables, and PDF receipts.
